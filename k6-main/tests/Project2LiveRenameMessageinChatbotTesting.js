...
export default function () {
  ...
  const chatListUrl = 'https://backend.project2.ai/bot/chat';
  const params = {
    headers: {
      'Content-Type': 'application/json',
      'Cookie': '_ga=GA1.1.1354052788.1744707320; _ga_JPKL68jK0S7=GS2.1.s1747128392$o6$g0$t1747128392$j0$l0$h0; _ga_CXZH6MT6H4=GS2.1.s1747203109$o17$g1$t1747203291$j0$l0$h0; token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwaG9uZSI6Ijg3NzkyOTY1MDAiLCJpYXQiOjE3NDczMDU4MTUsImV4cCI6MTc0NzQ3ODYxNX0.61vKjIDNKKxSa_kCh4V_6PnNqxFVkbl8vgPloXiub3E; _ga_JPKL68K0S7=GS2.1.s1747304152$o20$g1$t1747305858$j0$l0$h0; _dd_s=logs=1&id=2199a5f9-8cd1-4025-88a2-7337abea1f87&created=1747307331009&expire=1747308232040'
    },
    timeout: '10s',
  };
  ...
  const renameUrl = 'https://backend.project2.ai/bot/rename-question';
