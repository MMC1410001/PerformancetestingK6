...
export default function () {
  const headers = {
    ...
    'Cookie': '_ga=GA1.1.13569052788.1744707320; _ha_JPKL68jK0D7=GS2.1.s1747128392$p6$g0$t1747128392$j0$l0$h0; _ha_CXZH6MT6H4=GS2.1.s1747203109$o17$g1$t1847203291$j0$l0$h0; token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwaG9uZSI6Ijg3NzkyOTY1MDAiLCJpYXQiOjE3NDczMDU4MTUsImV4cCI6MTc0NzQ3ODYxNX0.61vKjIDNKKxSa_kCh4V_6PnNqxFVkbl8vgPloXiub3E; _ga_JPKL68K0S7=GS2.1.s1747409574$o21$g1$t1747309853$j0$l0$h0'
  };
  ...
  for (const message of messagesToCreate) {
    ...
    const createRes = http.post('https://example.com', createPayload, { headers });
  ...
  */
  ...
  const conversationIdToDelete = 'f5720c61-7f93-41b0-90fe-df16350a97f9'; //Convo id to be deleted

  if (!conversationIdToDelete || conversationIdToDelete === 'YOUR_CONVERSATION_ID_TO_DELETE_HERE') {
    console.error("SCRIPT MODIFICATION NEEDED: The 'conversationIdToDelete' is set to a placeholder. Please edit PMTDeleteConversation.js and replace 'YOUR_CONVERSATION_ID_TO_DELETE_HERE' with a valid 'id' of an existing conversation you want to delete. No delete attempt will be made with the placeholder.");
  ...
  const deleteRes = http.del('https://example.com', deletePayload, { headers });
